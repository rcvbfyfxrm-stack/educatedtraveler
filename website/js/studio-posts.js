 ...
 *  - Spine:  a skill, a place, a person, your people.
...
"Day four: foams and siphon techniques.\n\nHow foams actually stabilise — then hot, cold, fat-based, egg-white and starch foams, microwave sponges, foams for frying, and the Souflair.\n\nAt sea: a siphon earns its locker space on any boat. It's one of the few pieces of kit that pays for the volume it takes — sauces, garnishes, a hot foam, a sponge, a dessert element, all from the same canister. Most of us own one and use it for one thing. This is the day that fixes that.\n\n22–26 October, Vakuum, Barcelona, in English. It runs at ten paid.\n\neducatedtraveler.app/barcelona",
  },
  {
    ...
    slides: [],
    caption:
"Day five: sous-vide, properly.\n\nNot the water-bath-and-hope version. Pasteurisation theory, core temperatures, direct and double cooking, long cooks, brining, conservation and regeneration.\n\nIn service: cook once on a quiet day, regenerate perfectly for twelve covers. Every yacht chef already runs sous-vide. Very few of us were ever taught the pasteurisation tables that decide whether what we're doing is safe to hold for a week — and holding safely is the entire difference between a technique and a system.\n\nThis is the day that quietly changes how your whole season runs.\n\nFive days, 35 documented hours, in English, at his lab. It runs at ten paid by 15 September.\n\neducatedtraveler.app/barcelona",
  },
...
"It's real now — his own calendar says so.\n\nWhen you tell chefs you've arranged a week with Martin Lippo, the fair question is: says who? So here's the proof that costs me nothing to give you — the week is now published on his own site, under his name, and it says \"Organised by Educated Traveler\". 22-26 October, five days, 35 hours, English, fifteen places. martinlippo.com/professional-training-for-yacht-chefs/\n\nFor months this was a conversation and a handshake. Now there's a signed page: the dates, the refund terms, the certificate, what happens if we don't reach ten. All agreed and written down before a single chef was asked to pay. Slow is the honest speed.\n\nIt confirms the moment ten chefs are in, or everyone's refunded. Everything's checkable at the source: educatedtraveler.app/barcelona",
  ...
  {
    id: "lab-week-firstseats", format: "Feed · documentary arc · GO — seats are taken (Arnaud, 23 Aug 2026) · NO NUMBERS, ever", core: "",
    ...
    slides: [],
    caption:
"The first seats are taken.\n\nWorking chefs — winter programmes, charter calendars, real constraints — read the terms and paid.\n\nYou won't find a number on the page, and you won't get one from me. A running count is a scoreboard, and a scoreboard is how people get rushed into things. The mechanism is all you need: it runs at ten paid, it caps at fifteen, and if it doesn't get there by 15 September every euro goes back.\n\nWhat convinced them wasn't me. It was that every claim is checkable — his lab, his course catalogue, the names on his reviews, the refund line — and that the week sits in October, when the season finally exhales.\n\nThe rest of the room fills person by person: a message, a call, a held seat. No autopilot, no pressure — the terms do the talking.\n\neducatedtraveler.app/barcelona",
  },
  {
...
"PURPOSE — the pinned front door to the whole project: the first thing a new follower meets. WHEN — pin to the top of the profile; post fresh Tue or Thu, 6-8pm, when reach peaks. SHAPE — 6-slide carousel: slide 1 is the scroll-stopper, the last slide is the line + soft pull to the Atlas. Carousels get re-served for days, so reply to every comment to keep it breathing. NEXT — 24-48h later, run the Story below so anyone who visits the profile gets a second, interactive touch. WATCH — profile visits, Atlas clicks, Circle sign-ups.",
  },
  {
    ...
    story: [
      ...
      "Frame 3 — \"Pick your fire:\"  + POLL sticker → Freedive the Blue Hole / Sail the Solent.",
      "Frame 4 — \"Or this one:\"  + POLL sticker → Roll sushi in Tokyo / Pull espresso in a Roman bar.",
      "Frame 5 — \"Whatever came to mind first — there's a real place where it's still alive, and people already there.\"",
...
"PURPOSE — make people SURFACE a skill they secretly want: engagement and warm leads, not a sell. WHY STORIES — the Question and Poll stickers are the cheapest reach on the platform; every tap trains the feed, every typed answer is a person to DM. FLOW — hook (1) -> open question (2, the gold) -> two low-effort this-or-that polls (3-4, taps that pull people in) -> reframe (5) -> link out (6). AFTER — screenshot the best typed answers and reshare them as fresh frames (\"you said: ___ - here's where to learn it\") and reply to each with the matching Atlas page. CADENCE — run monthly; swap the two polls to match the season. WATCH — sticker taps, question replies, link-sticker taps -> Circle.",
  },
  {
    ...
    slides: [
      ...
      "I left school at eighteen and spent a decade cooking at sea. Every map I trusted ran out.",
...
"PURPOSE — explain the ONE thing that makes ET different now: the Circle is a letter, not a list. It surfaces warm leads who name their own craft. WHEN — run monthly, and any time after the founder story lands. SHAPE — 5-slide carousel; slide 4 (the letter) is the heart — linger there. Reply to every comment; carousels get re-served for days. LINK — /circle (the one link: the questionnaire, the letter, and one-tap magic-link signup all live there; /portrait is only where you land after signing up to access your portrait). WATCH — /circle visits, portraits sealed, replies. SAFE — signature-safe: names no master, place, or date.",
  },
  {
    ...
    slides: [
      ...
      "Some things only the source can teach.",
      "Find yours → the Circle",
    ],
    caption:
"A machine can show you almost anything now. It still can't teach your hands.\n\nThe things that change you are slow — learned by hand, with people, in a real place.\n\nThat's the whole idea. Find where your craft is alive: https://educatedtraveler.app/#circle",
    hashtags: "#learnbydoing #atthesource #educatedtraveler #craft #handmade",
  },
  {
    ...
    slides: [
      ...
      "Adventurous. Creative. At peace. At the stove.",
      "Then go where that craft is still alive.",
      "Open the Atlas →",
    ],
    caption:

  ...
  phases: [
    {
      ...
      steps: [
        ...
        { id: "lb-9", when: "When a seat is genuinely paid for", do: "Milestone story — a seat went, one line, link sticker. NO NUMBER: no counter goes on the page, ever (Arnaud, 23 Aug 2026).", where: "Posts → Milestone story", why: "A running count is a scoreboard, and a scoreboard rushes people. The mechanism — ten to run, fifteen to fill — is the only arithmetic that goes out." },

    ...
    function showSignInModal(prefillEmail = '') {
        ...
        modal.innerHTML = `
            ...
            <div role="dialog" aria-modal="true" aria-label="Account" class="relative glass rounded-2xl p-8 max-w-md w-full max-h-[90vh] overflow-y-auto" style="background:rgba(255,255,255,0.03);backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.06);">
                ...
                <!-- MAGIC LINK FORM -->
                <div id="auth-magiclink-container">
                    <h3 class="text-2xl font-light mb-2">Sign in</h3>
                    <p class="text-white/50 text-sm mb-6">There is no password here — put your email in and I send you a link that signs you in.</p>
        ...
        // Focus email input
        const emailInput = document.getElementById('auth-magic-email-input');
        if (emailInput) emailInput.focus();

        // View switching helpers
        function showView(viewId) {
            ['auth-magiclink-container', 'auth-success-container']

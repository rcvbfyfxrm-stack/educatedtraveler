...
Not a marketplace, and not first or only. The [Homo Faber Guide](https://www.homofaber.com/) has kept a larger free record for eight years. Every entry prints the way to reach the teacher directly, and what it costs, even when that is cheaper than the week I'd build.

And no promise about your hands. No study shows a week with a master beats the same hours practised alone, so I don't claim it. A week buys the room and the person.
...
data/repertoire.js  The Atlas data — window.ET_ATLAS
supabase/

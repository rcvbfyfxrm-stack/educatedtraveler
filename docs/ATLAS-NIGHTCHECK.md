...
_2026-09-26 — 378 published claims re-read against the pages they came from, across 33 open crafts._
...
- sound-healing · Pokhara Yoga School and Retreat Center — 17 nights, after 6 counted as failing by the older check — URLError: <urlopen error timed out>
...
- **perfumery · Musée International de la Parfumerie** — 11 nights — https://www.museesdegrasse.com/mip/presentation
...
- **perfumery · Un conservatoire de plantes à parfum** — 11 nights — https://www.museesdegrasse.com/mip/presentation
  - URLError: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1010)>

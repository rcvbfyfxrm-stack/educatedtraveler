...
_2026-09-18 — 378 published claims re-read against the pages they came from, across 33 open crafts._
...
- hatha-and-vinyasa-yoga · Atmavikasa Centre of Yogic Sciences — 2 nights — URLError: <urlopen error [Errno -3] Temporary failure in name resolution>
  - https://www.atmavikasayoga.in/
- sound-healing · Pokhara Yoga School and Retreat Center — 9 nights, after 6 counted as failing by the older check — URLError: <urlopen error timed out>
  - https://www.pokharayogaschoolandretreatcenter.com/
- thai-massage · ITM - International Training Massage School — 1 night — URLError: <urlopen error [Errno -3] Temporary failure in name resolution>
  - https://www.itmthaimassage.com/
- surfing · Canggu Bali Surf Lesson (Odysseys Surf School) — 1 night — URLError: <urlopen error timed out>
  - https://surflessoncanggu.com/
- french-pastry-and-patisserie · the CAP Pâtissier, the French state diploma — Bloc 1 — Petits fours et gâteaux de voyage — 2 nights — IncompleteRead: IncompleteRead(179130 bytes read)
...
- **cold-exposure-wim-hof-method · Innerfire BV** — 9 nights, after 6 counted as failing by the older check — https://www.innerfire.nl/
...
- **perfumery · Musée International de la Parfumerie** — 3 nights — https://www.museesdegrasse.com/mip/presentation
...
- **perfumery · Un conservatoire de plantes à parfum** — 3 nights — https://www.museesdegrasse.com/mip/presentation
  - URLError: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1010)>

## Back to normal

- kitesurfing · the IKO Kiteboarder levels
- kitesurfing · the IKO Kiteboarder levels — Level 1 — Discovery
- kitesurfing · the IKO Kiteboarder levels — Level 2 — Intermediate
- kitesurfing · the IKO Kiteboarder levels — Level 3 — Independent
- kitesurfing · the IKO Kiteboarder levels — Level 4 — Advanced

...
_2026-09-17 — 385 published claims re-read against the pages they came from, across 33 open crafts._
...
- organic-farm-to-table-cooking · Farm to Fork — HTTP 404 — https://www.ballymaloecookeryschool.ie/courses/farm-to-fork
...
- hatha-and-vinyasa-yoga · Indea Yoga — 1 night — URLError: <urlopen error timed out>
  - https://indeayoga.com/
- hatha-and-vinyasa-yoga · Atmavikasa Centre of Yogic Sciences — 1 night — URLError: <urlopen error [Errno -3] Temporary failure in name resolution>
  - https://www.atmavikasayoga.in/
- sound-healing · Pokhara Yoga School and Retreat Center — 8 nights, after 6 counted as failing by the older check — URLError: <urlopen error timed out>
...
- **cold-exposure-wim-hof-method · Innerfire BV** — 8 nights, after 6 counted as failing by the older check — https://www.innerfire.nl/
...
- **perfumery · Musée International de la Parfumerie** — 2 nights — https://www.museesdegrasse.com/mip/presentation
...
- **perfumery · Un conservatoire de plantes à parfum** — 2 nights — https://www.museesdegrasse.com/mip/presentation
  - URLError: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1010)>

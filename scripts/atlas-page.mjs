// atlas-page.mjs — the single source of truth for rendering a concierge skill
// row into a COMPLETE, self-contained Atlas discipline page (warm-dark editorial
// lock, ET tokens verbatim). Used by:
//   - the nightly build (renders page_html overnight so the page is DONE, not a sheet)
//   - scripts/concierge-publish.mjs (writes the approved page live)
// One renderer = the preview Arnaud approves is byte-identical to what publishes.
...
export function renderAtlasPage(row) {
...
<div id="et-nav-auth"><a href="/circle" id="et-nav-join" class="cta" style="margin:0;padding:8px 18px;font-size:13px;">Join the Circle</a><a href="/profile" id="et-nav-profile" class="cta" style="margin:0;padding:8px 18px;font-size:13px;display:none;">Your Profile</a></div>
</div></nav>
...
<p style="color:var(--muted);font-size:15px;">I'm Arnaud. Every school here has to clear the same bar: the craft is actually alive there, there's a named teacher, the credential is what it claims to be, and nobody paid to be listed. Where I'm still verifying something, I say so.</p>
...
<footer><div class="wrap"><p style="opacity:.82;margin:0 0 16px;max-width:60ch;line-height:1.7;">One page of a larger map. <a href="/atlas/" style="color:var(--sea);">Wander the rest of the Atlas</a>, read the longer stories in the <a href="/journal/" style="color:var(--sea);">Journal</a>, and when a week takes shape near what pulls you, <a href="/circle" style="color:var(--sea);">the Circle</a> is how I open the door.</p><div class="et-foot-nav" style="display:flex;gap:20px;flex-wrap:wrap;font-family:'IBM Plex Mono',monospace;font-size:12px;letter-spacing:.06em;text-transform:uppercase;margin:0 0 16px;"><a href="/atlas/" style="color:var(--sea);text-decoration:none;">Atlas</a><a href="/journal/" style="color:var(--sea);text-decoration:none;">Journal</a><a href="/lab-weeks" style="color:var(--sea);text-decoration:none;">Lab Weeks</a><a href="/about" style="color:var(--sea);text-decoration:none;">Meet the founder of EducatedTraveler</a><a href="/circle" style="color:var(--sea);text-decoration:none;">The Circle</a></div>EducatedTraveler — a bridge, not a shop. We connect you to the place, the person, and your people. <a href="/circle">Join the Circle</a>.<br><span style="opacity:.75">Privacy-light, cookieless analytics — no personal data, no tracking cookies.</span></div></footer>
</body></html>`;
}

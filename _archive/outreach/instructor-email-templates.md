...
## Email 1: First Outreach (Warm, Curious)

**Subject Line Options:**
- "Your work resonated — wanted to share something"
- "A different kind of teaching opportunity"
- "Building something for instructors who believe in depth"
...
I came across your [specific content: post about teaching methodology / video on alignment / thoughts on what makes training transformational] and it stuck with me.
...
We handle all the logistics. Instructors just teach.

I'm reaching out because the instructors we want to partner with are the ones who believe depth matters more than reach. Who'd rather work with 10 committed students than 100 casual ones.

If that sounds like you, I put together a page that explains more and has a simple form to connect:

[Link to instructors.html]

No pressure at all. If it's not a fit, no worries. But if you've ever wished you had more time with students who actually want to go deep—might be worth a look.
...
P.S. — We're starting with a pilot cohort in 2026 and looking for 1-2 instructors to build with from the beginning.

---

## Email 2: Gentle Follow-Up (7 Days Later)
...
If not, totally fine. Either way, wishing you well.

[Founder Name]

---

## Email 3: If They're Not Available (Referral)
...
Thanks for getting back to me. Completely understand that the timing isn't right.

Quick question: Do you know anyone who might be a good fit? We're looking for instructors who share that belief in going deep rather than wide.
...
## Email 4: Personalized (For Instructors Whose Work Really Resonates)

**Subject:** Your post on [topic] made me want to reach out

---

Hi [Name],

I read your [post / watched your video] about [specific thing] and it really landed.
...
We handle all the logistics—venue, transport, meals, paperwork. Instructors just teach.

I'm not trying to pitch you. I'm trying to find people who believe the same things we do about what makes learning transformational. Your work suggests you might.
...
Before sending, spend 5 minutes finding:
1. Specific video or post to reference
2. Their teaching philosophy (from bio or content)
3. Where they're currently teaching
4. Any unique methodology they mention
5. Mutual connections if possible

### Response Tracking

| Name | Discipline | Sent Date | Opened? | Replied? | Status | Notes |
|------|-----------|-----------|---------|----------|--------|-------|
| | | | | | | |
...
- Day 0: Initial email
- Day 7: Warm follow-up (if no response)
- Day 14: Final follow-up or referral ask
- Day 21: Move to inactive
...
**Signs of alignment:**
- Asks thoughtful questions about the students or experience
- Shares why the philosophy resonates with their own beliefs
- Mentions wanting more time with students
- Shows curiosity about building something together
- Teaching-focused content (methodology, insights, real moments)
- Engaged community in their comments
- Clear articulation of what they believe about learning

**Signs it might not be the right fit:**
- Only focused on compensation details
- No curiosity about the students or approach
- Content is mostly lifestyle/personal brand focused
- Inflexible about methodology or collaboration
- Dismissive about the time required

---

## Form Submission: Where It Goes

The form in `instructors.html` needs a backend. Options:

| Option | How It Works | Best For |
|--------|--------------|----------|
| **Google Forms** | Create a form, embed or link to it | Matches your customer survey setup |
| **Formspree** | Sign up free, get a form ID, submissions go to email | Simple, quick to set up |
| **Netlify Forms** | Add `netlify` attribute to form tag | If already hosting on Netlify |
| **Airtable** | Create form, embed, submissions become database rows | Tracking + light CRM |

**Recommended:** Google Forms (consistency) or Formspree (simplicity)
...
3. Create new form
4. Copy form ID
5. Replace `YOUR_FORM_ID` in instructors.html with your ID
6. Submissions go directly to your email

...
function issue01Html(unsub: string): string {
  const body = `
      <p style="${P}margin:0 0 16px 0;">This is the first proper letter from the Circle. Here's how it will go: now and then, one place worth knowing — a single craft, the town where it's most alive, and the people you'd meet if you went. No selling — just the map, and the occasional introduction. When there's a week worth paying for, I'll say so plainly, once, and you decide.</p>
...
function issue02Html(unsub: string): string {
  const body = `
      ...
      <p style="${P}margin:0 0 16px 0;">Now the rest makes sense. In a city of 186,000, {N_THREE_STAR} kitchens hold three Michelin stars — {NAMES} — all within a few kilometres of one small bay. In the 1970s two locals, Juan Mari Arzak and Pedro Subijana, came home from France with the ideas of nouvelle cuisine, refused to merely copy them, and built something of their own: Nueva Cocina Vasca. The world followed. Later the Basques founded the Basque Culinary Center — a full university faculty for cooking, grown straight out of that same circle.</p>
...
function issue03Html(unsub: string): string {
  const body = `
      ...
      <p style="${P}margin:0 0 16px 0;"><strong style="color:#2b2621;">In Barcelona — Martin Lippo.</strong> An Argentine chef who arrived in 2000 and became one of Spain's pioneers of sous-vide and low-temperature cooking. He took the avant-garde toolkit that Ferran Adrià unleashed — the foams, the spherification, the work with liquid nitrogen — and instead of guarding it behind a restaurant pass, he built a laboratory called <em style="color:#4a423b;">Vakuum</em> to teach it, hands-on, to anyone serious enough to show up. I met him there, in person. The door is open.</p>
      <p style="${P}margin:0 0 16px 0;"><strong style="color:#2b2621;">In Bologna — Alessandra Spisni.</strong> A <em style="color:#4a423b;">sfoglina</em>: she rolls pasta by hand with a meter-long pin, the way Emilia-Romagna has for centuries. Since 1993 she has run La Vecchia Scuola Bolognese, a school dedicated to training <em style="color:#4a423b;">sfogline</em> — the women who keep tortellini and tagliatelle alive as living knowledge, not a museum piece.</p>
      ...
      <p style="${P}margin:0 0 16px 0;">What links them isn't fame. It's that they teach — at the source, with their own hands on the work beside yours. That is the rarest and most valuable thing in any craft. Craft has been mapped — for collectors, and for heritage. It has never been mapped for someone who wants to go and learn.</p>
      <p style="${P}margin:0 0 28px 0;">So I've started to. On the Atlas, the places where a real master will actually take you on now carry a single mark — <strong style="color:#2b2621;">Takes students directly.</strong> It's the opposite of a listicle ranked by who paid, and the opposite of a screen you watch alone. It's a door, with a name on it.</p>
...
<body style="margin:0;padding:0;background:#faf8f4;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#ffffff;border:1px solid #e6ded1;border-radius:16px;padding:36px 28px;">
      ...
      <p style="${P}margin:0 0 18px 0;">I'm keeping the details close while the dates and the master's side lock in &mdash; but I want you near it as it firms up &mdash; you'll hear it before it goes wide.</p>
...
<body style="margin:0;padding:0;background:#faf8f4;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#ffffff;border:1px solid #e6ded1;border-radius:16px;padding:36px 28px;">
      ...
      <p style="${P}margin:0 0 22px 0;">I don't sell you a week. I take what you tell me and go looking for the real thing &mdash; the master still teaching by hand, the place where the craft is alive, and your people. I'm building it, then I'll open the door.</p>

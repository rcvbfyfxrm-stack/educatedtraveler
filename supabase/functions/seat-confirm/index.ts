...
function letterHtml(name: string, paid: number, balance: number, when: string): string {
  ...
  <div style="max-width:540px;margin:0 auto;padding:0 26px;">
    ...
    <p style="color:#6b625a;font-family:Georgia,serif;font-style:italic;font-size:15px;margin:0;border-top:1px solid #e2dbd0;padding-top:18px;">A place, a person, your people.</p>
  </div>
</div>`;
}
